...
* [czl0325/coin11-tb](https://github.com/czl0325/coin11-tb) - 使用uiautomator2自动化完成淘宝双11的金币任务，618金币任务，淘金币任务，芭芭农场任务，闲鱼任务，支付宝打卡任务。
...
* [tencentmusic/cube-studio](https://github.com/tencentmusic/cube-studio) - cube studio开源云原生一站式机器学习/深度学习/大模型AI平台，mlops算法链路全流程，算力租赁平台，notebook在线开发，拖拉拽任务流pipeline编排，多机多卡分布式训练，超参搜索，推理服务VGPU虚拟化，边缘计算，标注平台自动化标注，deepseek等大模型sft微调/奖励模型/强化学习训练，vllm/ollama/mindie大模型多机推理，私有知识库，AI模型市场，支持国产cpu/gpu/npu 昇腾生态，支持RDMA，支持pytorch/tf/mxnet/deepspeed/paddle/colossalai/horovod/ray/volcano等分布式
...
* [RealCorebb/bbGesture](https://github.com/RealCorebb/bbGesture) - A Gesture Sensor that works through objects.
...
* [LiRenTech/visual-file-qt](https://github.com/LiRenTech/visual-file-qt) - 大型文件夹二维直观可视化，开发辅助工具，便于点击文件立刻触发在IDE中打开，解决IDE项目文件过多上下翻阅麻烦的问题。
...
* [wyourname/Bilibili\_Python](https://github.com/wyourname/Bilibili_Python) - 仅供参考
...
* [feicong/re-docs](https://github.com/feicong/re-docs) - reverse engineering docs.
...
* [MonsterNone/tmall-miao](https://github.com/MonsterNone/tmall-miao) - 喵币助手：618天猫（淘宝）、京东任务一键完成。电脑版，支持Android和HarmonyOS Next
...
* [hingston/7-billion-humans-solutions](https://github.com/hingston/7-billion-humans-solutions) - Solutions for the game 7 Billion Humans
...
* [MCQTSS/MCQTSS\_QQMusic](https://github.com/MCQTSS/MCQTSS_QQMusic) - QQ音乐解析
...
* [camprevail/pet-pet-gif](https://github.com/camprevail/pet-pet-gif) - Python adaptation of https://github.com/aDu/pet-pet-gif
...
* [laorange/bilibili\_downloader](https://github.com/laorange/bilibili_downloader) - 基于httpx和pyside6的哔哩哔哩(bilibili)视频下载程序
...
* [qbmiller/wikiShare](https://github.com/qbmiller/wikiShare) - 写了一个基于 Cloudflare 的私有文档分享工具。  支持上传文档、在线阅读、账号密码访问、文件有效期控制，也可以生成免登录分享链接，并单独设置分享有效期。文件存储在 Cloudflare，不需要自建服务器，适合替代网盘公开链接。CFSahre/wikiShare
...
* [oversizexl/ForkFlow](https://github.com/oversizexl/ForkFlow) - ForkFlow ⚡ 一键批量同步 GitHub Fork，自动清理僵尸仓库，让你的分叉永远与上游保持光速同步！🔥
...
* [gadore/ink-screen-bluetooth](https://github.com/gadore/ink-screen-bluetooth) - An script that can control a inkScreen with bluetooth protocol
...
* [JasonKhew96/tg-join-captchas-web-bot](https://github.com/JasonKhew96/tg-join-captchas-web-bot) -
...
* [aDu/pet-pet-gif](https://github.com/aDu/pet-pet-gif) - Given an avatar, generate a petting gif (known as "petpet" or "pet the").
...
* [AestasBritannia/Hydro-Br-leur](https://github.com/AestasBritannia/Hydro-Br-leur) - A magisk module for Android devices
...
* [Yeuoly/Echidna](https://github.com/Yeuoly/Echidna) - Discover the contributions of every team member with ease using this Visual Studio Code extension.
...
* [KunMoe/kun-galgame-stickers](https://github.com/KunMoe/kun-galgame-stickers) - KUN's Visual Novel (galgame) sticker set. To recommend games to more people. Galgame 表情包仓库
...
* [WordlessEcho/Variable-Font-Test](https://github.com/WordlessEcho/Variable-Font-Test) - Variable Font Test - Test variable font in system or from file.

* [1250422131/bilibilias](https://github.com/1250422131/bilibilias) - 哔哩哔哩视频解析工具实验学习项目，不发布产物。

* [HolographicHat/GetToken](https://github.com/HolographicHat/GetToken) - -> account/ma-cn-session/app/getTokenBySToken
...
* [Four-JJJJ/oh-myusage](https://github.com/Four-JJJJ/oh-myusage) - macOS menu bar app to monitor AI plan limits, relay balances, and local Codex accounts
...
* [onllm-dev/onWatch](https://github.com/onllm-dev/onWatch) - Track AI API quotas across Synthetic, Z.ai, Anthropic (Claude Code), Codex, GitHub Copilot & Antigravity in real time. Lightweight background daemon (<50MB RAM), SQLite storage, Material Design 3 dashboard. Zero telemetry.
...
* [itzg/mc-monitor](https://github.com/itzg/mc-monitor) - Monitor the status of Minecraft servers and provides Prometheus exporter and Influx line protocol output
...
* [Xianyu39/obsidian-just-write](https://github.com/Xianyu39/obsidian-just-write) - 一款基于Obsidian定制的文章写作软件。
...
* [EVAyo/script](https://github.com/EVAyo/script) -
...
* [DSVVA/KuRo\_Scanner](https://github.com/DSVVA/KuRo_Scanner) - 鸣潮扫码登录器，支持从直播流抢码
...
* [PKUHPC/CraneSched](https://github.com/PKUHPC/CraneSched) - A distributed scheduling system for HPC and AI workloads
...
* [CICADA8-Research/Spyndicapped](https://github.com/CICADA8-Research/Spyndicapped) - COM ViewLogger — new malware keylogging technique
...
* [archive-chan/CustomReminder](https://github.com/archive-chan/CustomReminder) - 根据自定义预设的内容进行倒计时,倒计时结束后发出Toast通知
...
* [Icingworld/Steganalysis-LSB](https://github.com/Icingworld/Steganalysis-LSB) - 图片隐写术之LSB，Least Significant Bit for image

* [luxiaolan6373/JBMN](https://github.com/luxiaolan6373/JBMN) - v3
...
* [bin-u/Arduino-fingerprint](https://github.com/bin-u/Arduino-fingerprint) - Arduino指纹解锁门禁系统
...
* [YuehaiTeam/kachina-installer](https://github.com/YuehaiTeam/kachina-installer) - Universal installer based on tauri. Offline or online install, diffed online upgrade, uninstall and more.
...
* [JADE-Jerry/jcalendar](https://github.com/JADE-Jerry/jcalendar) - Ink Screen Calendar
...
* [MS10755/12864OLED\_Anime](https://github.com/MS10755/12864OLED_Anime) - 12864 OLED 动画示例项目，包含Windows模拟器（基于SDL2）
...
* [bilibilifmk/ESP\_weather\_Cube](https://github.com/bilibilifmk/ESP_weather_Cube) - 基于esp8266+0.96oled的气象站桌面时钟
...
* [blackinkkkxi/RAG\_langchain](https://github.com/blackinkkkxi/RAG_langchain) - 一个基于langchain实现RAG的简单示例
...
* [hellodk34/GetMyV2exTopicsList](https://github.com/hellodk34/GetMyV2exTopicsList) - get my v2ex topics list. 快速获取 v2ex 上我收藏的帖子列表
...
* [blaisewang/img2latex-mathpix](https://github.com/blaisewang/img2latex-mathpix) - Mathpix has changed their billing policy and no longer has free monthly API requests. This repo is now archived and will not receive any updates for the foreseeable future.
...
* [wyusagi/Proof\_Yajuu](https://github.com/wyusagi/Proof_Yajuu) -
...
* [Hessel2333/alipay\_record\_analysis](https://github.com/Hessel2333/alipay_record_analysis) - 支付宝账单分析
...
* [SukkaW/ClashEditor](https://github.com/SukkaW/ClashEditor) - :triangular\_ruler: An editor for writing Clash config
